...
struct MemoFolder3: View {
    
    var videoName: String = "MemoFolder3"
    ...
    var body: some View {
        ...
        VStack {
            ZStack {
                ...
                TouchCircle(isGestured: $isGestured, player: player, xOffset: -70, yOffset: 182, opacity: 0.5)
            }
        }
...
struct MemoFolder3_Previews: PreviewProvider {
