...
struct MemoMove1: View {
    
    var videoName: String = "MemoMove1"
    ...
    var body: some View {
        ...
        VStack {
            ZStack {
                ...
                TouchCircle(isGestured: $isGestured, player: player, xOffset: 66, yOffset: -200, opacity: 0.5)
            }
        }
...
struct MemoMove1_Previews: PreviewProvider {
