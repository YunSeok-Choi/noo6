...
struct MemoMove3: View {
    
    var videoName: String = "MemoMove3"
    ...
    var body: some View {
        ...
        VStack {
            ZStack {
                ...
                TouchCircle(isGestured: $isGestured, player: player, xOffset: -50, yOffset: -40, opacity: 0.5)
            }
        }
...
struct MemoMove3_Previews: PreviewProvider {
